...
public class MenuBar extends JMenuBar {
    ...
    public MenuBar() {
        ...
        authors.add(jd1);
        jd1.addActionListener(arg0 -> JOptionPane.showMessageDialog(null, d1,
                "Quine McCluskey Prime Implicant Generator",
                JOptionPane.INFORMATION_MESSAGE));

        JMenuItem jd2 = new JMenuItem("Developer 2", KeyEvent.VK_N);
        authors.add(jd2);
        jd2.addActionListener(arg0 -> JOptionPane.showMessageDialog(null, d2,
                "Quine McCluskey Prime Implicant Generator",
                JOptionPane.INFORMATION_MESSAGE));

        JMenuItem jd3 = new JMenuItem("Developer 3", KeyEvent.VK_N);
        authors.add(jd3);
        jd3.addActionListener(arg0 -> JOptionPane.showMessageDialog(null, d3,
                "Quine McCluskey Prime Implicant Generator",
                JOptionPane.INFORMATION_MESSAGE));
